...
public class RequestLogAspect {
    ...
    @Pointcut("within(jnpf.*.controller.* || jnpf.controller.*)")// && !within(jnpf.controller.UtilsController)
        ...
        if (userInfo.getUserId() != null && (!configValueUtil.isMultiTenancy() || TenantHolder.getLocalTenantCache() != null)) {
            ...
            try {
                ...
                if (methodAnnotation != null) {
                    ...
                    handleLog(userInfo, costTime, obj, moduleName, args, signature);
                }
            } catch (Exception e) {
    ...
    private void printLog(UserInfo userInfo, long costTime, Object obj, Object[] args, Signature signature) {
        ...
        for (Object o : args) {
            ...
            if (o instanceof MultipartFile) {
                stringBuilder.append("{\"originalFilename\":\"").append(((MultipartFile) o).getOriginalFilename()).append("\",");
                stringBuilder.append("\"contentType\":\"").append(((MultipartFile) o).getContentType()).append("\",");
                stringBuilder.append("\"name\":\"").append(((MultipartFile) o).getName()).append("\",");
                stringBuilder.append("\"resource\":\"").append(((MultipartFile) o).getResource()).append("\",");
                stringBuilder.append("\"size\":\"").append(((MultipartFile) o).getSize()).append("\"}");
            }
        }
     ...
     * @param args          请求参数
     */
    private void handleLog(UserInfo userInfo, long costTime, Object obj, String moduleName, Object[] args, Signature signature) {
        LogEntity entity = new LogEntity();
        entity.setId(RandomUtil.uuId());
