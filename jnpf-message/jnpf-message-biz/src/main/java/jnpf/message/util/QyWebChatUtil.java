...
public class QyWebChatUtil {
    ...
    public static JSONObject getAccessToken(String corpId, String corpSecret) {
        return HttpUtil.httpRequest(String.format(TOKEN, corpId, corpSecret), "GET", null);
    }
    ...
    public static JSONObject sendWxMessage(String corpId, String corpSecret, String agentId, String toUserId, String contents) {
        ...
        if (tokenObject.getString(KeyConst.ACCESS_TOKEN) != null && !"".equals(tokenObject.getString(KeyConst.ACCESS_TOKEN))) {
            retMsg = sendMessage(message.toJSONString(), tokenObject.getString(KeyConst.ACCESS_TOKEN));
        } else {
