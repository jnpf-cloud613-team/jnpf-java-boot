...
public interface YozoService extends SuperService<FileEntity> {
     ...
     * @return
     */
    ActionResult<Object> saveFileId(String fileVersionId, String fileId, String fileName);
     ...
     * @return
     */
    ActionResult<Object> saveFileIdByHttp(String fileVersionId, String fileId, String fileUrl);
     ...
     * @return
     */
    ActionResult<Object> deleteFileByVersionId(String versionId);
     ...
     * @return
     */
    ActionResult<Object> deleteBatch(String[] versions);
