...
public class SynQyWebChatUtil {
     ...
     */
    public static JSONObject createDepartment(String department, String accessToken) {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
        String qyDeptId = "0";
     ...
     * @throws WxErrorException
     */
    public static JSONObject updateDepartment(String department, String accessToken) {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
     ...
     * @throws WxErrorException
     */
    public static JSONObject deleteDepartment(String id, String accessToken) {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
     ...
     * @throws WxErrorException
     */
    public static JSONObject getDepartmentList(String id, String accessToken)  {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
     ...
     * @throws WxErrorException
     */
    public static JSONObject createUser(String user, String accessToken) {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
     ...
     * @throws WxErrorException
     */
    public static JSONObject updateUser(String user, String accessToken) {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
     ...
     * @throws WxErrorException
     */
    public static JSONObject deleteUser(String id, String accessToken) {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
     ...
     * @throws WxErrorException
     */
    public static JSONObject getUserById(String id, String accessToken) {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
        String userInfo = "";
     ...
     * @throws WxErrorException
     */
    public static JSONObject getLinkedcorpUserById(String id, String accessToken)  {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
        String userInfo = "";
     ...
     * @throws WxErrorException
     */
    public static JSONObject getUserList(String id, String isGetChild, String accessToken) {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
        ...
        if (HttpUtil.isWxError(rstObj)) {
            ...
            userList = JsonUtil.getJsonToList(rstObj.getJSONArray(USER_LIST));
        }
        retMsg.put("code",codeFlag);
        retMsg.put(ERROR,errorMsg);
        retMsg.put(USER_LIST,userList);
        return retMsg;
    }
     ...
     * @throws WxErrorException
     */
    public static JSONObject getUserDetailList(String id, String isGetChild, String accessToken) {
        JSONObject retMsg = new JSONObject();
        boolean codeFlag = true;
        String errorMsg = "";
        String userList = "";
        JSONObject rstObj = HttpUtil.httpRequest(String.format(GET_SINGLE_USER, accessToken, id,isGetChild), "GET", null);
        if (HttpUtil.isWxError(rstObj)) {
            codeFlag = false;
            errorMsg = rstObj.toString();
        }else{
            userList = rstObj.getString(USER_LIST);
        }
        retMsg.put("code",codeFlag);
        retMsg.put(ERROR,errorMsg);
        retMsg.put(USER_LIST,userList);
